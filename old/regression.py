...
class Regressor:
    """
    A regressor dedicated to prediction on the tails of the covariates.
    
    Parameters
    ----------
    model : object
        The model to be used for regression. Must have a `.fit` method and a
        `.predict' method.
    ...
    ----------
    model : object
        The model used for regression. It is a `copy.deepcopy` (hard copy) of
        the argument passed to the contructor.
